...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <!-- Vendor CSS Files -->
  <link href="{{assset('assets/vendor/animate.css/animate.min.css')}}" rel="stylesheet">
  <link href="{{assset('assets/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
  <link href="{{assset('assets/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
  <link href="{{assset('assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
  <link href="{{assset('assets/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
  <link href="{{assset('assets/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">
